...
<div class="flex justify-center items-center h-screen bg-red-50">
	<div>
		...
		<form class="w-full max-w-lg mt-8" action="../ajouter/categorie" method="POST">
		  <div class="flex flex-wrap -mx-3 mb-6">
		    <div class="w-full px-3 mb-6 md:mb-0">
		      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-id">
		        Id Categorie
		      </label>
		      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-id" type="number" placeholder="id Categorie ...." name="idCat" required>
		    </div>
		    <div class="w-full px-3 mb-6 md:mb-0">
